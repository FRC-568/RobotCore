...
public class CrateBot extends IterativeRobot {
	protected static CrateBot instance;
	public OI oi;
	...
	public void robotInit() {
		...
		// CrateBot.getInstance().referenceframe.imu.calibrate();
	...
	public static CrateBot getInstance() {
		return instance;
	}
}
